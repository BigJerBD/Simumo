...
use dim::si::{Meter,Second,Kilogram,MeterPerSecond,MeterPerSecond2};
...
pub fn meterpersecond2_deserialize<'de,D>(deserializer: D) -> Result<MeterPerSecond2<Fdim>, D::Error>
    where D: Deserializer<'de>{
